    ...
    <section class="cs-grid" aria-label="維修統計內容">
      <div class="cs-panel">
        ...
        <div class="cs-tableWrap">
          <table class="cs-table" id="csSummaryTable" aria-label="車輛彙總表">
            <thead>
              <tr>
                <th>車輛編號</th>
                <th>車牌</th>
                <th class="ta-r">次數</th>
                <th class="ta-r">公司負擔</th>
                <th class="ta-r">工班負擔</th>
                <th class="ta-r">總金額</th>
                <th>維修最多(Top3)</th>
              </tr>
            </thead>
            <tbody id="csSummaryBody">
              <tr><td colspan="7" class="cs-empty">載入中…</td></tr>
            </tbody>
          </table>
        </div>
      </div>
      ...
      <div class="cs-panel">
        ...
        <div class="cs-tableWrap">
          <table class="cs-table" id="csDetailsTable" aria-label="維修明細表">
            <thead>
              <tr>
                <th>車輛編號</th>
                <th>維修日期</th>
            ...
            <tbody id="csDetailsBody">
              <tr><td colspan="6" class="cs-empty">請先選擇車輛…</td></tr>
            </tbody>
          </table>
        </div>
      </div>
