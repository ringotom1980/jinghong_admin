      ...
      <div class="hot-pane__body">
        <div class="hot-tableWrap" id="hotVehWrap">
          <table class="table hot-table hot-table--veh" aria-label="車輛配賦清單">
            <thead>
              <tr>
                <th style="width:100px;">車輛編號</th>
                <th style="width:120px;">車牌</th>
                <th style="width:86px;">狀態</th>
                <th style="width:96px; text-align:right;">已配賦件數</th>
                <th style="width:72px;">功能</th>
              </tr>
            </thead>
            <tbody id="tbHotVeh">
              <tr class="hot-empty"><td colspan="5">尚無配賦車輛</td></tr>
            </tbody>
          </table>
        </div>
      ...
      <div class="hot-pane__body">
        <div class="hot-tableWrap" id="hotAssignWrap">
          <table class="table hot-table hot-table--assign" aria-label="該車配賦工具清單">
            <thead>
              <tr>
                <th style="width:86px;">分類</th>
                <th style="width:110px;">工具編號</th>
