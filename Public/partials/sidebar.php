...
<aside class="sidenav" id="sidenav" aria-label="側邊導覽">
  <div class="sidenav__rail" aria-hidden="false">
    <a class="rail__tab" data-nav="dashboard" data-drawer="drawer-dashboard" href="<?= htmlspecialchars($base . '/dashboard', ENT_QUOTES) ?>">
      <span class="tab__icon" aria-hidden="true"><i class="fa-solid fa-gauge-high"></i></span>
      <span class="tab__abbr">儀錶板</span>
    </a>

    <a class="rail__tab" data-nav="mat" data-drawer="drawer-mat" href="<?= htmlspecialchars($base . '/mat/issue', ENT_QUOTES) ?>">
      <span class="tab__icon" aria-hidden="true"><i class="fa-solid fa-boxes-stacked"></i></span>
      <span class="tab__abbr">領退管理</span>
    </a>

    <a class="rail__tab" data-nav="car" data-drawer="drawer-car" href="<?= htmlspecialchars($base . '/car/base', ENT_QUOTES) ?>">
      <span class="tab__icon" aria-hidden="true"><i class="fa-solid fa-car"></i></span>
      <span class="tab__abbr">車輛管理</span>
    </a>

    <a class="rail__tab" data-nav="equ" data-drawer="drawer-equ" href="<?= htmlspecialchars($base . '/equ/repairs', ENT_QUOTES) ?>">
      <span class="tab__icon" aria-hidden="true"><i class="fa-solid fa-screwdriver-wrench"></i></span>
      <span class="tab__abbr">工具管理</span>
    </a>

    <a class="rail__tab" data-nav="pole" data-drawer="drawer-pole" href="<?= htmlspecialchars($base . '/pole-map', ENT_QUOTES) ?>" target="_blank" rel="noopener">
